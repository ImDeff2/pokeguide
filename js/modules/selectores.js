//* Navbar
export const menuNavbarBtn = document.querySelector("#menu");
export const sidebar = document.querySelector("#sidebar");
export const closeSidebarBtn = document.querySelector(".sidebar__close")
export const sidebarDropdownBtn = document.querySelector("#dropdown-button");
...
export const modalPokemonImg = document.querySelector(".modal__img");
export const modalPokemonTypes = document.querySelector(".modal__types");
export const modalPokemonDescription = document.querySelector(".modal__description");
export const modalPokemonWeight = document.querySelector("#weight");
export const modalPokemonHeight = document.querySelector("#height");
export const modalStats = document.querySelectorAll(".stat__item");
